                ...
                <div className='flex items-center gap-3'>
                    <div className='avatar online'>
                        <button className='size-14 rounded-full overflow-hidden relative group'
                            ...
                            <img src={selectedImg || authUser.profilePic || '/avatar.png'} alt='avatar profile'
                                className='size-full object-cover'></img>
                ...
                <div className='flex gap-4 items-center'>
                    ...
                    <button className='text-slate-400 hover:text-slate-200 transition-colors'
                        onClick={() => {
                            ...
                            toggleSound()
                        }}>{isSoundEnabled ? (<Volume2Icon className='size-5'></Volume2Icon>) : (<VolumeOffIcon className='size-5'></VolumeOffIcon>)}</button>
                </div>
            </div>
        </div>
    )
